...
const WHATSAPP_NUMBER = '23058311584';
...
app.use(session({
  secret: process.env.SESSION_SECRET || 'trusted-kanine-secret-change-in-production',
  resave: false,
...
app.listen(PORT, function () {
  console.log('Trusted Kanine server running at http://localhost:' + PORT);
  console.log('Admin: set ADMIN_PASSWORD in .env and open /admin.html to log in.');
});
